    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forRoot(appRoutes, { enableTracing: true } //debugging only
                )
            ],
            providers: [],
...
var ExpenseComponent = /** @class */ (function () {
    function ExpenseComponent(http) {
        this.http = http;
    }
    ExpenseComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('/expenses').subscribe(function (data) {
            _this.expenses = data;
        });
    };
...
module.exports = __webpack_require__(/*! c:\Users\cozaci\Desktop\Working-Personal\projects\myhomeexpenses\frontend\src\main.ts */"./src/main.ts");
